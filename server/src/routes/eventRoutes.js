...
const { createEvent, getEvents, getEventById, addTeamMemberToEvent, removeTeamMemberFromEvent, updateEvent, deleteEvent } = require('../controllers/eventController');
...
router.delete('/:eventId/members/:memberId', authenticateUser, requireRole(USER_ROLES.ADMIN), removeTeamMemberFromEvent);
